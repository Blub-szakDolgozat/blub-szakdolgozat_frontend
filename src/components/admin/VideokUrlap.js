...
export default function VideokUrlap() {
  ...
  return (
    <div className='container'>
        <form onSubmit={kuld}>
        <div className="mb-3">
            <label htmlFor="cim" className="form-label">A videó címe:</label>
            <input
                type="text"
            ...
            <div className="mb-3">
            <label htmlFor="link" className="form-label">A videó linkje:</label>
            <input
                type="url"
                className="form-control"
                id="link"
            ...
            <div>
            {errors.link && (
                <span className="text-danger">{errors.link[0]}</span>
            )}
            </div>
        ...
        <div>
          {errors.nyitokep && <span className="text-danger">{errors.nyitokep[0]}</span>}
        </div>



        <div className="mb-3">
            <label htmlFor="hossz" className="form-label">A videó hossza:</label>
            <input
                type="number"
                min={1}
